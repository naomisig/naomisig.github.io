...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=366987');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "366987");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "bf1ae180d45300494860d486dca7f28af558f3fff6b5233aa55e04e02c15c8cd");
define('CREATED_TIMESTAMP', "1704451805");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor366987');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor366987');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "naomisig.github.io",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "naomisig.github.io",
));
